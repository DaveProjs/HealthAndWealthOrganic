...
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'smartline-lite' ); ?></a>
...
<div id="wrapper" class="hfeed">
	...
	<div id="header-wrap">
		...
		<?php endif; ?>
				<?php //echo do_shortcode('[caption id="headImg" width="124" ]  [/caption]'); ?> 
